...
namespace TripsTrapsTrull
{
    ...
    public partial class Game : ContentPage
    {
        ...
        public Game()
        {
            ...
            {
                Children = { uus_mang, pravila },
            };
            StackLayout knopki3 = new StackLayout
            {
                Children = { pole, temapilti/*, zvuk */},
            };
        ...
        private void Temapilti_Clicked(object sender, EventArgs e)
        {
            int i = 0;
            Random r = new Random();
            pokazatel.BackgroundColor = Color.FromRgb(r.Next(0, 256), r.Next(0, 256), r.Next(0, 225));
            grid2x1.BackgroundColor = Color.FromRgb(r.Next(0, 256), r.Next(0, 256), r.Next(0, 225));
            i++;
            try
            {
